...
namespace MongoDB.AspNet.Identity
{
    ...
    public class UserStore<TUser> : UserStore<TUser, IdentityRole, ObjectId, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>, IUserStore<TUser>, IUserStore<TUser, ObjectId>, IDisposable
