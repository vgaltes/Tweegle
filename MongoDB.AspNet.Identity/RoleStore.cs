...
namespace MongoDB.AspNet.Identity
{
    ...
    public class RoleStore<TRole> : RoleStore<TRole, ObjectId, IdentityUserRole>, IQueryableRoleStore<TRole>, IQueryableRoleStore<TRole, ObjectId>, IRoleStore<TRole, ObjectId>, IDisposable
